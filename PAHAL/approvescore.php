...
<head>
  ...
  <title>LPG pahal scheme application </title>
  <link rel="stylesheet" type="text/css" href="style.css" />
</head>
<body>
  <h2>Approve an application for LPG subsidy</h2>
...
<?php
  ...
  if (isset($_POST['submit'])) {
    if ($_POST['confirm'] == 'Yes') {
      ...
      $query = "UPDATE subsidy SET approved = 1 WHERE id = $id";
      mysqli_query($dbc, $query);
      mysqli_close($dbc);

      // Confirm success with the user
      echo '<p>the application ' . $score . ' for ' . $name . ' was successfully approved.';
    }
    else {
    ...
    echo '<p>Are you sure you want to confirm the application?</p>';
